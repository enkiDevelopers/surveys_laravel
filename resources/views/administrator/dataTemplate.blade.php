    ...
    <a href="/administrator/previewtem/{{$eid}}/" target="_blank" class="btn btn-preview" style="background: gray;color:white;position: relative; z-index: 1;/*box-shadow: 3px 3px 3px #616161;*/">
      <span class=" glyphicon glyphicon-eye-open"></span>
        ...
        <div id="dataContainer" style="position: relative; z-index: 0;">
       		<div class="col-md-3 col-img" style="margin-top: -14%;margin-left: -21px;">
       			<center>
            ...
            <div class="col-md-8 col-desc" style="margin-top: -13%;margin-bottom: 5%;margin-left:257px;">
                <textarea rows="4" cols="50" class="form-control text-black" disabled id="inputDesc" aria-describedby="desc" placeholder="Descripción" style="overflow-y: auto;">{{$descripcion}}</textarea>
            </div>
        </div>
</div>
