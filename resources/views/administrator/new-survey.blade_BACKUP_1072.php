...
<<<<<<< HEAD
                    <div class="new-survey__question-container" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control text-black" id="exampleInputEmail1" onkeyup="validar();" aria-describedby="emailHelp" placeholder="Respuesta">
                           </div>
                            <div class="col-md-2">
...
>>>>>>> 5eb7ece3b3b9a53ead189f1a1ed92d1299b8be85
                        </div>
...
//        $("#home").addClass('active');
    ...
    function validar(){
        ...
        if ( titulo != "") {
            ...
            alert("Ingrese un Titulo antes de continuar");
