...
//$(document).ready(
function GraficaFiltro(url_local){
	console.log("La url_local es: "+url_local);
	$.ajax({
		url: url_local,
		...
		success: function(data) {
			var c = document.getElementById("barras_detalle");
			var cv = c.getContext("2d");
			cv.clearRect(0, 0, barras_detalle.width, barras_detalle.height);
			console.log(data);
