...
$sql .="/*Concatena*/
	,CAST(ROUND((CAST(SUM(Q.Encuestado) AS decimal)/ CAST((SUM(Q.Total)-SUM(Q.Incidencia)) AS decimal)),4) AS decimal(5,4)) AS Avance
...
$sql .="
	ORDER BY 
	   CAST(ROUND((CAST(SUM(Q.Encuestado) AS decimal)/ CAST((SUM(Q.Total)-SUM(Q.Incidencia)) AS decimal)),4) AS decimal(5,4)) DESC, 
";
